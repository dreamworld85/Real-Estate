...
function PropertyLocationMap({ latitude, longitude, title, address, district }: { latitude?: number | string | null; longitude?: number | string | null; title: string; address: string; district: string }) {
  ...
  return (
    <div className="bg-white rounded-2xl border border-charcoal/5 p-4 shadow-sm flex flex-col gap-3 text-left">
      <div className="flex items-center justify-between">
        <div>
          <h3 className="font-display font-extrabold text-xs text-ink uppercase tracking-wider">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="px-2.5 py-1 bg-emerald-50 hover:bg-emerald-100 text-emerald-800 text-[9.5px] font-extrabold rounded-xl border border-emerald-500/15 transition-all flex items-center gap-1 cursor-pointer"
        >
          <span>Open Directions</span>
        </a>
      </div>

      <div className="relative w-full h-48 rounded-xl overflow-hidden border border-charcoal/8 bg-slate-100 shadow-inner">
